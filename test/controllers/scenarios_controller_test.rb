...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post scenarios_url, params: { scenario: { creator_id: @scenario.creator_id, detail: @scenario.detail, info: @scenario.info, member_num: @scenario.member_num, npc_info: @scenario.npc_info, promotion: @scenario.promotion, title: @scenario.title } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { creator_id: @scenario.creator_id, detail: @scenario.detail, info: @scenario.info, member_num: @scenario.member_num, npc_info: @scenario.npc_info, promotion: @scenario.promotion, title: @scenario.title } }
